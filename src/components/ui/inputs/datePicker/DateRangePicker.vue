...
const emit = defineEmits<{
  (e: 'select-dates', dates: DateRange): void
}>()

const todaysDate = new Date()
const todaysCalendarDate = new CalendarDate(
...
watch(value, (value) => emit('select-dates', value))
</script>
  ...
  <Popover>
    <PopoverTrigger as-child>
      ...
      >
        ...
        <template v-else> Choisissez une date </template>
      </Button>
    </PopoverTrigger>
